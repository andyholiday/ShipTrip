...
**Stand (2026-09-14):** Build 33 (1.9.0) mit Widgets „Dynamic Instrument“ release-verifiziert auf TestFlight; `feature/widget-politur` nach `main` gemerged, `main` und Tags v1.9.0-b30 bis b33 auf GitHub. Offen: Andres Gerätebestätigung der Widgets (Build 33), Apple-Processing.
...
- [ ] Widget 1.9.0 — Plan: `.planning/TASKPLAN-widget-1.9.0.md`
...
- [x] Kreuzfahrt teilen (Export/Import .shiptrip, W1–W3) — 2026-09-09 · Evidenz: `.winston-evidence/share-w3/` · `CHANGELOG.md`
- [x] Release 1.8.0 auf TestFlight (Build 25) — 2026-09-10 · Evidenz: `CHANGELOG.md`
